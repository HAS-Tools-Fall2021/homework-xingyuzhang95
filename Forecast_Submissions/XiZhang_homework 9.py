...
ax.set_ylabel('Streamflow (m^3/s)',fontsize=30,fontweight='bold',color='red')
ax.set_title('Weekly mean streamflow and precipitation',fontsize=30,fontweight='bold')
ax2=fig.add_subplot(gspec[1])
ax2.plot(W_prcp.index, W_prcp['prcp'],color='blue')
...
ax2.set_ylabel('Precipitation (mm/day)',fontsize=30,fontweight='bold',color='blue')
